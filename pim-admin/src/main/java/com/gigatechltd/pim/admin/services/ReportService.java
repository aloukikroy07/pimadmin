...
//	}
    ...
    public List<CustomerProfile>  getCpData(CustomerProfile cp) {
    	List<CustomerProfile>  cpData = reportRepository.getCustomerProfile(cp);
    	return cpData;
	}
    
//    public String exportJasperReport(HttpServletResponse response, CustomerProfile cp) throws IOException {
//		String path = "C:\\Users\\User\\Downloads";
//		String destFileName = path+"\\report.html";
//		JRBeanCollectionDataSource jrbcd = null;
//		File template;
//		try {
////			List<CustomerProfile> customerProfileData = reportRepository.getCustomerProfile(cp);
